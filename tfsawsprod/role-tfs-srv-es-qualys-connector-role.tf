resource "aws_iam_role" "tfs-srv-es-qualys-connector-role" {
  ...
  "{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Principal":{"AWS":"arn:aws:iam::805950163170:root"},"Action":"sts:AssumeRole","Condition":{"StringEquals":{"sts:ExternalId":"1536022249834"}}}]}"
  EOF
