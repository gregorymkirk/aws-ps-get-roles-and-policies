resource "aws_iam_role" "tfsawsprod_compute_readonly" {
  name = "tfsawsprod_compute_readonly"
...
resource "aws_iam_role_policy_attachment" "tfsawsprod_compute_readonly0" {
  role       = "${aws_iam_role.tfsawsprod_compute_readonly.id}"
