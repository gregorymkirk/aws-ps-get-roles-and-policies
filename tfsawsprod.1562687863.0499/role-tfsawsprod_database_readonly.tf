resource "aws_iam_role" "tfsawsprod_database_readonly" {
  name = "tfsawsprod_database_readonly"
...
resource "aws_iam_role_policy_attachment" "tfsawsprod_database_readonly0" {
  role       = "${aws_iam_role.tfsawsprod_database_readonly.id}"
